"""
This file is copied directly from the Kaleido repository:
https://github.com/tsor13/kaleido/blob/main/KaleidoSys.py
"""
...
class KaleidoSys:
    ...
    def get_output(self, action, n_gens=20, sample=False, explain=False, get_embeddings=False, explanation_decoding_params={}):
